		...
		public class quiz2 {
		  private static Scanner scanner = new Scanner(System.in);
		    ...
		    public static void main(String[] args) {
		        ...
		        System.out.println("MinElementChallenge: " + findMAX(returnArray));
		    }
		    ...
		    private static int findMAX(int[] array) {
		        int MinElementChallenge = Integer.MAX_VALUE;
		        for (int i = 0; i < array.length; i++) {
		            int value = array[i];
		            if (value < MinElementChallenge) {
		            	MinElementChallenge = value;
		            }
		        }
		        return MinElementChallenge;
		    }
		}
